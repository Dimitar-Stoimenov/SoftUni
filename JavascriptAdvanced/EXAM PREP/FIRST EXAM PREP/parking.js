...
console.log(valueAddCar)//.to.be.eq(expectedValueAddCar);
console.log(valuePay)//.to.be.eq(expectedValuePay);
console.log(valueRemoveCar)//.to.be.eq(expectedValueRemoveCar);