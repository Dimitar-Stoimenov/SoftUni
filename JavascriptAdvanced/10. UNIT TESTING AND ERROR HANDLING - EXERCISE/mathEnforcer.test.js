...
describe('Math Enforcer', () => {
    describe('addFive', () => {
        ...
        it('adds 5 to a floating number', () => {
            expect(mathEnforcer.addFive(0.01)).closeTo(5.01, 0.01);
            expect(mathEnforcer.addFive(1.0001)).closeTo(6.0001, 0.01);
            expect(mathEnforcer.addFive(-1.0001)).closeTo(3.9999, 0.01);
        });
    ...
    describe('subtractTen', () => {
        ...
        it('subtracts 10 from a floating number', () => {
            expect(mathEnforcer.subtractTen(0.01)).closeTo(-9.99, 0.01);
        });
    ...
    describe('sum', () => {
        ...
        it('returns the sum of two floating numbers', () => {
            expect(mathEnforcer.sum(0.01, 0.02)).closeTo(0.03, 0.01);
            expect(mathEnforcer.sum(0.001, 0.002)).closeTo(0.003, 0.01);
        });
        it('returns the sum of an integer and a floating number', () => {
            expect(mathEnforcer.sum(1, 0.01)).closeTo(1.01, 0.01);
        });
